...
EXPOSE 8080
ENTRYPOINT java\
-DJDBC_URL=${JDBC_URL} -DJDBC_DRIVER=${JDBC_DRIVER}\
-DJDBC_USER=${JDBC_USER}\
-DJDBC_PASSWORD=${JDBC_PASSWORD}\
-DJWT_SECRET_KEY=${JWT_SECRET_KEY}\
-DJWT_EXPIRATION_TIME=${JWT_EXPIRATION_TIME}\
-DS3_ACCESS_KEY=${S3_ACCESS_KEY}\
-DS3_SECRET_KEY=${S3_SECRET_KEY}\
-DS3_BUCKET_NAME=${S3_BUCKET_NAME}\
-DS3_REGION=${S3_REGION}\
-jar /usr/local/lib/becommerce.jar
